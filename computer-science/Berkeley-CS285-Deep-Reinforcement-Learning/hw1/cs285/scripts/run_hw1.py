...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          training_indices = np.random.permutation(len(replay_buffer))[:params["train_batch_size"]]
          ob_batch, ac_batch = replay_buffer.obs[training_indices], replay_buffer.acs[training_indices]
