...
if args.function == 'pretrain':
    ...
    tn = trainer.Trainer(model, pretrain_dataset, None, tconf)
    if __name__ == "__main__": # for Windows process-related problem
        tn.train()
    ...
    tn = trainer.Trainer(model, finetune_dataset, None, tconf)
    if __name__ == "__main__": # for Windows process-related problem
        tn.train()
