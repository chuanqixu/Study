...
string_view Reader::peek() const
{
  ...
  // it is complicated for the string_view return version of peek to return multiple bytes with the deque implementation
  // since string_view is just the view of the string
