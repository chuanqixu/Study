...
# FIX: mapLoop:
    # FIX: add t1, s0, x0      # load the address of the array of current node into t1
    lw t1, 0(s0)
    lw t2, 4(s0)        # load the size of the node's array into t2
mapLoop:
    # FIX: add t1, t1, t0      # offset the array address by the count
    ...
    # FIX: lw a1, 0(s1)        # put the address of the function back into a1 to prepare for the recursion
    add a1, s1, x0
